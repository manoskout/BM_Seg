...
class Patient:
    ...
    def get_patient_metadata(self,) -> dcm.dicomdir.DicomDir:
        """
    ...
    def dicom_extraction(self) -> np.ndarray:
        dicom_files = []
    ...
    def get_shape(self) -> tuple:
        return (
            self.patient.DirectoryRecordSequence[0].Rows,
    ...
    def load_volume_parameters(self) -> None:
    ...
    def data_ROI_only(self):
        indexes = self.get_segmented_region()
        masks = []
        slices = []
        for i in indexes:
    ...
    def get_bounding_box(self, cX, cY, box_size=(40, 40)):
        """
    ...
    def save_volume_with_ROI_only(self, save_metadata=True):
